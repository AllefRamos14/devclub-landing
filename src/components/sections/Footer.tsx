...
const CTAOrb = styled(motion.div)`
  position: absolute;
  top: -70px;
  right: -70px;
...
const FloatingMark = styled(motion.span)`
  position: absolute;
  z-index: -1;
    ...
    <FooterWrap>
      <Container>
        <FooterGrid>
          ...
          <FooterColumn>
            <ColTitle>Formações</ColTitle>

            <FooterLink href="#formacoes">
              Full Stack
            </FooterLink>
          ...
          <FooterColumn>
            <ColTitle>DevClub</ColTitle>

            <FooterLink href="#quem-somos">
              Quem somos
            </FooterLink>

            <FooterLink href="#tutores">
              Tutores
            </FooterLink>

            <FooterLink href="#alunos">
              Alunos
            </FooterLink>
          </FooterColumn>
          ...
          <FooterColumn>
            ...
            <FooterLink href="#empresas">
              Empresas
            </FooterLink>

            <FooterLink href="#numeros">
              Resultados
            </FooterLink>
